      ...
      <section className="bg-white rounded-xl shadow-[0_14px_34px_rgba(15,23,42,0.06)] border border-[#e2e8f0] p-[2rem] w-full min-w-0 mt-0 max-[520px]:p-4">
        ...
        <div className="min-w-0 border border-[#e2e8f0] rounded-[10px] p-[1.5rem] max-[520px]:p-4">
          <div className="flex justify-between items-start mb-[1.25rem] gap-4 max-[700px]:flex-col">
            <div className="min-w-0"><h3 className="m-[0_0_6px] break-words !text-[1.15rem] !text-[#0f172a] !font-[800]">{appeal.title || appeal.subject}</h3><p className="m-0 break-words !text-[0.85rem] !text-[#475569] !font-[600]">{formatSubmitted(appeal.createdAt)} <span className="mx-[6px] text-[#cbd5e1]">|</span> Assigned CI: {appeal.instructorName || "Not assigned"}</p></div>
