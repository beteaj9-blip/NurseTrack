...
export const roleNavConfigs: Record<string, Omit<NavItem, 'isActive'>[]> = {
  admin: [
    ...
    { label: "Manual Attendance", topbarTitle: "Manual Attendance Review", href: "/admin/manual-backup", icon: ManualBackupIcon },
  ...
  chair: [
    ...
    { label: "Manual Attendance", topbarTitle: "Manual Attendance Review", href: "/chair/manual-backup", icon: ManualBackupIcon },
  ...
  assistant: [
    ...
    { label: "Manual Attendance", topbarTitle: "Manual Attendance Review", href: "/assistant/manual-backup", icon: ManualBackupIcon },
  ...
  coordinator: [
    ...
    { label: "Manual Attendance", topbarTitle: "Manual Attendance Review", href: "/coordinator/manual-backup", icon: ManualBackupIcon },
  ...
  "clinical-instructor": [
    ...
    { label: "Manual Attendance", topbarTitle: "Manual Attendance", href: "/clinical-instructor/manual-backup", icon: ManualBackupIcon },
