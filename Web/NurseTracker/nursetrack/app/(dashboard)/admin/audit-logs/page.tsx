    ...
    <main className="p-[clamp(20px,3vw,36px)] min-h-[calc(100vh-64px)] content-start">
      <section className="bg-white rounded-xl shadow-[0_14px_34px_rgba(15,23,42,0.06)] border border-[#e2e8f0] p-[1.45rem_1.55rem_0.35rem] max-[820px]:p-[1.2rem]">
        ...
        <div className="w-full overflow-hidden border border-[#dbe3ee] rounded-[14px] bg-white">
          <div className="grid grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)_minmax(0,1.15fr)_minmax(0,0.95fr)] items-center gap-x-[1.25rem] w-full p-[1.05rem_1.25rem] bg-[#f8fafc] border-b border-[#dbe3ee] max-[1180px]:hidden"><span className="!text-[#0b1b3a] !text-[0.78rem] !font-[900] uppercase tracking-[0.045em] whitespace-nowrap min-w-0">Actor</span><span className="!text-[#0b1b3a] !text-[0.78rem] !font-[900] uppercase tracking-[0.045em] whitespace-nowrap min-w-0">Action</span><span className="!text-[#0b1b3a] !text-[0.78rem] !font-[900] uppercase tracking-[0.045em] whitespace-nowrap min-w-0">Affected Record</span><span className="!text-[#0b1b3a] !text-[0.78rem] !font-[900] uppercase tracking-[0.045em] whitespace-nowrap min-w-0 justify-self-start text-left">Time</span></div>
          {pagedLogs.map(log => { const affected = affectedRecord(log); return <div className="grid grid-cols-[minmax(0,1fr)_minmax(0,0.9fr)_minmax(0,1.15fr)_minmax(0,0.95fr)] items-center gap-x-[1.25rem] w-full min-w-0 min-h-[72px] p-[0.92rem_1.25rem] border-b border-[#e5eaf1] last:border-b-0 max-[1180px]:grid-cols-1 max-[1180px]:gap-y-[0.45rem] max-[1180px]:p-[1rem]" key={log.id}><span className="min-w-0"><strong className="block !text-[#020617] !text-[0.86rem] leading-[1.25] !font-[900] break-words">{log.actor}</strong><small className="block mt-[0.2rem] !text-[#1e3a5f] !text-[0.72rem] !font-[800] leading-[1.2] break-words">{formatRole(log.actorRole)}</small></span><span className="min-w-0"><strong className="block !text-[#020617] !text-[0.84rem] leading-[1.25] !font-[900] break-words">{log.action}</strong></span><span className="min-w-0"><strong className="block !text-[#020617] !text-[0.86rem] leading-[1.25] !font-[900] break-words">{affected.name}</strong><small className="block mt-[0.2rem] !text-[#1e3a5f] !text-[0.72rem] !font-[800] leading-[1.2] break-words">{affected.context}</small></span><span className="min-w-0 justify-self-start text-left whitespace-nowrap max-[1180px]:whitespace-normal max-[1180px]:mt-[0.25rem]"><strong className="block !text-[#020617] !text-[0.84rem] leading-[1.25] !font-[900]">{formatTime(log.occurredAt)}</strong></span></div>; })}
        </div>
