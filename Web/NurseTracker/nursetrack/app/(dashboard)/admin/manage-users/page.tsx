        ...
        <section className="w-full">
          <article className="mt-0 p-[1.45rem] rounded-lg border border-[#e2e8f0] bg-white shadow-[0_16px_44px_rgba(32,33,36,0.07)]">
            ...
            <div className={`grid grid-cols-[minmax(160px,0.72fr)_minmax(160px,0.72fr)_minmax(160px,0.72fr)_minmax(300px,1.6fr)] gap-[0.85rem] mb-4 p-[0.95rem] border border-[#e5eaf1] rounded-lg bg-[#f8fafc] max-[680px]:grid-cols-1 ${roleFilter !== "student" ? "is-non-student-role" : ""}`}>
              ...
              <label className={`flex flex-col gap-1.5 m-0 !text-sm !font-bold !text-[#344054] max-[680px]:col-auto ${roleFilter !== "student" ? "min-[681px]:col-start-3 min-[681px]:col-span-2" : "min-[681px]:col-start-4 min-[681px]:col-span-1"}`}>Search<input className="min-h-[44px] px-3 py-2 border border-[#d0d5dd] rounded-lg bg-white !text-[#111827] !font-medium focus:ring-2 focus:ring-[#8A252C]/20 focus:border-[#8A252C] outline-none transition-all" type="search" placeholder="Search name, ID, email" value={search} onChange={e => setSearch(e.target.value)} /></label>
            </div>
