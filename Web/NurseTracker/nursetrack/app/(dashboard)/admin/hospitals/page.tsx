...
export default function HospitalsDutyAreasPage() {
  ...
  return (
    <>
      <main className="min-w-0 overflow-x-hidden p-[clamp(16px,3vw,42px)] content-start grid gap-4 w-full pt-8">
        <section className="mt-6 grid min-w-0 grid-cols-1 gap-6 items-stretch min-[1280px]:grid-cols-2">
          <article className="min-w-0 p-[1.45rem] rounded-lg border border-[#e2e8f0] bg-white shadow-[0_16px_44px_rgba(32,33,36,0.07)] flex flex-col">
            ...
            <form className="grid min-w-0 grid-cols-2 gap-4 gap-y-5 items-start flex-1 max-[720px]:grid-cols-1" onSubmit={handleAddHospital}>
              <label className="min-w-0 flex flex-col gap-1.5 m-0 !text-sm !font-bold !text-[#344054]" htmlFor="hospital-name">Hospital Name<input className={inputClass} id="hospital-name" name="hospitalName" type="text" placeholder="Cebu City Medical Center" required /></label>
              <label className="min-w-0 flex flex-col gap-1.5 m-0 !text-sm !font-bold !text-[#344054]" htmlFor="hospital-code">Short Code<input className={inputClass} id="hospital-code" name="hospitalCode" type="text" placeholder="CCMC / VSMMC" required /></label>
          ...
          <article className="min-w-0 mt-0 p-[1.45rem] rounded-lg border border-[#e2e8f0] bg-white shadow-[0_16px_44px_rgba(32,33,36,0.07)] flex flex-col">
            ...
            <form className="grid min-w-0 grid-cols-2 gap-4 gap-y-5 items-start flex-1 max-[720px]:grid-cols-1" onSubmit={handleAddDutyArea}>
              <label className="min-w-0 flex flex-col gap-1.5 m-0 !text-sm !font-bold !text-[#344054]" htmlFor="duty-area-name">Duty Area<input className={inputClass} id="duty-area-name" name="dutyAreaName" type="text" placeholder="Emergency Room" required /></label>
